...
export const BatchOperate = ({ show, onOk, onClose }: { show: boolean, onOk: (v: IForm) => void, onClose: () => void }) => {
    ...
    return (
        <div style={{ padding: '8px', border: '1px soild #999', margin: '8px 0', width: '640px' }}>
            ...
            <div style={{ textAlign: 'right' }}>
                <Button size="small" style={{ marginRight: '16px' }} onClick={onClose}>收起设置</Button>
                <Button type="primary" size="small" disabled={checkList.length === 0} onClick={() =>{
                    const v = {}
