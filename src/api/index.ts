...
export const getAllMerchandise =async (params: IAllMerchandiseParams) => {
    return Api.get<ResponseApi<IMerchandiseRes>>('pdd/tr/list', params as Record<string, string>).then(({ code, data }) => {
...
export const updateOptimizationBid =async (goodsId: number, optimizationBid: number) => {
    return Api.post<ResponseApi<null>>('pdd/tr/modify/optimization-bid', { goodsId, optimizationBid })
}
